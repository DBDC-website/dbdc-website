...
type AnimatedPageHeaderProps = {
   ...
   * `sky` — cool blue wash for interiors with stained-glass / cool photography.
...
export default function AnimatedPageHeader({
  ...
  const isLight = isCathedral || isSky;
  ...
  const ruleClass = cn(
    isSky
      ? 'mt-8 h-px w-24 bg-gradient-to-r from-[#00a0dc] via-[#5bb8d9] to-transparent'
      : isCathedral
        ...
        <>
          ...
          <div
            className={cn(
              'absolute inset-0',
              isSky
                ? 'bg-gradient-to-b from-transparent via-[#d8eef8]/14 to-[#d8eef8]/5'
                : isCathedral
          ...
          <div
            className={cn(
              'absolute inset-0',
              isSky
                ? 'bg-[radial-gradient(ellipse_at_50%_38%,rgba(220,242,252,0.7)_0%,rgba(180,220,240,0.35)_34%,transparent_58%),radial-gradient(ellipse_at_18%_20%,rgba(0,160,220,0.22),transparent_45%)]'
                : isCathedral
