...
function ExperienceCard({
  ...
  return (
    <motion.a
      ...
      className="group block h-full rounded-2xl focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#00a0dc]"
    ...
    >
      <article className="flex h-full flex-col overflow-hidden rounded-2xl border border-[#d2a73c]/35 bg-[#fffdf9]/95 shadow-sm shadow-brand-900/[0.04] transition-[border-color,box-shadow] duration-500 group-hover:border-[#00a0dc]/45 group-hover:shadow-lg group-hover:shadow-[#0a6f96]/10">
        <div className="relative aspect-[16/10] overflow-hidden sm:aspect-[5/3]">
          ...
          />
          <div
            className="absolute inset-0 bg-gradient-to-t from-brand-950/45 via-brand-950/10 to-transparent"
            aria-hidden="true"
          />
        ...
        <div className="flex flex-1 flex-col p-5 transition-colors duration-500 group-hover:bg-[#f7f1e8]/60 sm:p-6 lg:p-7">
          <h3 className="text-xl font-semibold text-brand-900 sm:text-2xl">{title}</h3>
          <p className="mt-3 flex-1 text-sm leading-relaxed text-stone-600 sm:text-base">
            {description}
          </p>
          <span className="mt-5 inline-flex items-center gap-2 text-sm font-semibold text-[#0a6f96] transition-colors duration-300 group-hover:text-brand-900">
            <span className="border-b border-transparent pb-0.5 transition-[border-color] duration-300 group-hover:border-[#d2a73c]">
              {cta}
            </span>
            <span className="flex h-8 w-8 items-center justify-center rounded-full bg-sky-100 text-[#0a6f96] transition-all duration-300 group-hover:bg-gold-100 group-hover:text-gold-700">
              <ArrowUpRight
